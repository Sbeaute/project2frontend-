...
var backendEvents = __webpack_require__(11);

$(function () {
  authEvents.addHandlers();
  backendEvents.addHandlers();
});
...
var ui2 = __webpack_require__(13);
...
var showInventories = function showInventories(event) {
  event.preventDefault();
  console.log(event);

  api.showinventories().then(ui2.showInventoriessuccess).catch(ui2.failure);
};

var deleteInventories = function deleteInventories(event) {
  event.preventDefault();
  var data = $('#inv-del').val();
  console.log(data);

  api.deleteinventories(data).then(ui2.deleteInventoriesSuccess).catch(ui2.failure);
};

var updateInventories = function updateInventories(event) {
  event.preventDefault();
  var invId = $('#inv-up-id').val();
  var invBrand = $('#inv-up-brand').val();
  var invModel = $('#inv-up-model').val();
  var invImg = $('#inv-up-imgurl').val();
  ...
  api.updateinventories(invId, invBrand, invModel, invImg).then(ui2.updateInventoriesSuccess).catch(ui2.failure);
};

// else {
//   console.log('Please provide a inventories id!')

var createInventories = function createInventories(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createinventories(data).then(ui2.createInventoriesSuccess).catch(ui2.failure);
};
...
var showinventories = function showinventories(id) {
...
var deleteinventories = function deleteinventories(id) {
  return $.ajax({
...
var updateinventories = function updateinventories(invId, invBrand, invModel, invImg) {
  return $.ajax({
...
var createinventories = function createinventories(data) {
  return $.ajax({
    url: config.apiUrl + '/inventories/',
    method: 'POST',
    headers: {
...
module.exports = {
  ...
  createinventories: createinventories
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var showInventoriessuccess = function showInventoriessuccess(data) {
...
var deleteInventoriesSuccess = function deleteInventoriesSuccess() {
...
var updateInventoriesSuccess = function updateInventoriesSuccess() {
...
var createInventoriesSuccess = function createInventoriesSuccess() {
...
module.exports = {
  showInventoriessuccess: showInventoriessuccess,
  failure: failure,
  deleteInventoriesSuccess: deleteInventoriesSuccess,
  updateInventoriesSuccess: updateInventoriesSuccess,
  createInventoriesSuccess: createInventoriesSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
